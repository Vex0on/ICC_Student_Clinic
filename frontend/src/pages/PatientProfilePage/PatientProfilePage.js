    ...
    return (
      <div className={styles.container}>
        ...
        <div className={styles.container__data}>
          <div>
            <Avatar text={`${patientData.first_name} ${patientData.last_name}`} imageSrc={ProfileImage} />
          </div>
  
          <div className={styles.container__icons}>
            <InformationsIcon text={patientData.pesel} icon={<AiOutlineHeart />} />
            <InformationsIcon text={patientData.date_of_birth} icon={<AiOutlineCalendar />} />
            <InformationsIcon text={patientData.address} icon={<LuMapPin />} />
            <InformationsIcon text={patientData.phone_number} icon={<BsTelephone />} />
          </div>
        </div>
      </div>
    );
